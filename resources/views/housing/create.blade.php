            ...
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header">
                        <h3 class="text-center font-weight-light my-4">Creer un logement</h3>
                    </div>
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="title" type="text" name="title"
                                            placeholder="Entrez le titre du logement" value="{{ old('title') }}" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <textarea class="form-control" name="description" id="description" placeholder="Decrivez le logement"
                                            value="{{ old('description') }}" cols="30" rows="10">Description</textarea>
                                    </div>
                                    <div class="text-danger">
                                        @error('description')
                                            {{ $message }}
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="address" type="text" name="address"
                                            placeholder="Entrez l'adresse du logement" value="{{ old('address') }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="number_salons" type="number" name="number_salons"
                                            placeholder="Entrez le nombre de salon" value="{{ old('number_salons') }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="number_rooms" type="number" name="number_rooms"
                                            placeholder="Entrez le nombre de chambre" value="{{ old('number_rooms') }}" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="price" type="text" name="price"
                                            placeholder="Entrez le prix du logement" value="{{ old('price') }}" />
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid"><button type="submit"
                                        class="btn btn-primary btn-block">Creer</button></div>
                            </div>
                        </form>
                    </div>
                </div>
